---
{"dg-publish":true,"permalink":"/cognitive-science/before-mid/lecture-2-the-problem-of-induction-bayesian-inference-and-hypothesis-space/"}
---

# Outline
[[Cognitive Science/Before Mid/Lecture 2 - The Problem of Induction, Bayesian Inference, and Hypothesis Space#Part 1 The Problem of Induction\|The Problem of Induction]]
[[Cognitive Science/Before Mid/Lecture 2 - The Problem of Induction, Bayesian Inference, and Hypothesis Space#Part 2 Bayesian Inference\|Bayesian Inference]]
[[Cognitive Science/Before Mid/Lecture 2 - The Problem of Induction, Bayesian Inference, and Hypothesis Space#Part 3 Hypothesis Space\|Hypothesis Space]]
...
1. Calculate Posterior for $h_{biased}$: 
   $$P(hb|d) = \frac{Likelihood × Prior Total}  {Probability (Evidence)} = \frac{0.9 × 0.5}{ 0.70} = \frac{0.45} {0.70} ≈ 0.643$$
2. After seeing one Head, our belief that the coin is biased increased from 50% to 64.3%
3. Repeat the same 3 steps after getting a second head using 0.643 as the new prior, the prior will increase further more to 76.4%
